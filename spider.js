...
const mquote = {
    ...
    message: {
        conversation: "𝚂𝙽𝙾𝚆-𝙼𝙳 ᴏᴘᴛɪᴍɪᴢᴇᴅ ʙʏ 𝙹𝙾𝙽 𝚂𝙽𝙾𝚆 ᴛᴇᴄʜ 🕷️"
    }
};
...
const developers = ["50938758188", "50955217986"]; 
...
const isAdmins = isGroup ? groupAdmins.includes(nowsender) : false;
    ...
    if (m.quoted) {
        try {
            ...
            const caption = quotedMsg.caption || `*𝚂𝙽𝙾𝚆-𝙼𝙳 ꜱᴀᴠᴇ* ✨`;
...
> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝙹𝙾𝙽 𝚂𝙽𝙾𝚆 ᴛᴇᴄʜ*`;
 ...
 thumbnailUrl: "https://files.catbox.moe/3gitrg.jpg",
...
`;
 ...
 externalAdReply: {
 title: "𝚂𝙽𝙾𝚆-𝙼𝙳 ᴀssɪsᴛᴀɴᴛ",
 body: "ᴀᴜᴛᴏᴍᴀᴛᴇᴅ ʙᴏᴛ ʙʏ 𝙹𝙾𝙽 𝚂𝙽𝙾𝚆",
 thumbnail: buffer,
...
case 'repo': {
 ...
 const repoMsg = `🍂 *${toSmallCaps("Snow md repository")}*

*╭┄┄◆ ${toSmallCaps("project details")} ◆*
*│ ◈ ${toSmallCaps("name")} : snow md*
*│ ◈ ${toSmallCaps("author")} : Jon snow Tech*
...
> *${toSmallCaps("get the latest version and documentation on our official website below")}* ⚡`;
 ...
 body: { text: repoMsg },
 footer: { text: "𝚂𝙽𝙾𝚆-𝙼𝙳 ᴏᴘᴛɪᴍɪᴢᴇᴅ ʙʏ 𝙹𝙾𝙽 𝚂𝙽𝙾𝚆 ᴛᴇᴄʜ" },
 nativeFlowMessage: {
 buttons: [
 {
 name: "cta_url",
 buttonParamsJson: JSON.stringify({
 display_text: toSmallCaps("open you md web"),
...
case 'vs': {
 ...
 packname: "𝚂𝚃𝙰𝚁 𝙹𝙾𝙽 𝚂𝙽𝙾𝚆 𝙿𝚁𝙸𝙼𝙴",
 author: "𝙹𝙾𝙽 𝚂𝙽𝙾𝚆 𝚃𝙴𝙲𝙷𝚇"
 });
...
case 'ai': {
 try {
 const axios = require('axios');
 if (!text) return m.reply(`*snow ᴀɪ* 🕷️\n\nʜᴇʟʟᴏ! ɪ ᴀᴍ snow ᴀɪ, ᴄʀᴇᴀᴛᴇᴅ ʙʏ *Jon snow ᴛᴇᴄʜ*. ʜᴏᴡ ᴄᴀɴ ɪ ᴀssɪsᴛ ʏᴏᴜ ᴛᴏᴅᴀʏ?`);

 // Visual reaction while processing
 await sock.sendMessage(m.chat, { react: { text: "🔍", key: m.key } });

 // System Prompt: English Instructions for Identity & Behavior
 const systemPrompt = `ʏᴏᴜʀ ɴᴀᴍᴇ ɪs snow ᴀɪ. ʏᴏᴜʀ ᴄʀᴇᴀᴛᴏʀ ɪs Jon snow ᴛᴇᴄʜ. 
 ʏᴏᴜ ᴀʀᴇ ᴀ ʜɪɢʜʟʏ ɪɴᴛᴇʟʟɪɢᴇɴᴛ ᴀɴᴅ ʜᴇʟᴘғᴜʟ ᴀssɪsᴛᴀɴᴛ. 
 ᴀʟᴡᴀʏs ʀᴇsᴘᴏɴᴅ ɪɴ ᴛʜᴇ sᴀᴍᴇ ʟᴀɴɢᴜᴀɢᴇ ᴛʜᴇ ᴜsᴇʀ sᴘᴇᴀᴋs. 
 ɴᴇᴠᴇʀ ᴍᴇɴᴛɪᴏɴ ᴊᴇᴇᴠᴇs ᴏʀ ғᴀᴀ. ɪғ ᴀsᴋᴇᴅ ᴡʜᴏ ʏᴏᴜ ᴀʀᴇ, sᴀʏ ʏᴏᴜ ᴀʀᴇ snow ᴀɪ, ᴀɴ ᴀᴜᴛᴏᴍᴀᴛᴇᴅ ʙᴏᴛ ʙʏ Jon snow ᴛᴇᴄʜ.`;
 ...
 .replace(/Jeeves AI/gi, "SNOW AI")
 .replace(/Faa/gi, "Jon snow Tech");

 await sock.sendMessage(m.chat, { 
 text: `*snow ᴀɪ* 🕷️\n\n${finalReply}\n\n> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ Jon snow ᴛᴇᴄʜ*`,
 contextInfo: {
 externalAdReply: {
 title: "snow ᴀɪ ᴄᴏɴᴠᴇʀsᴀᴛɪᴏɴ",
 body: "ᴘᴏᴡᴇʀᴇᴅ ʙʏ Jon snow ᴛᴇᴄʜ",
 thumbnailUrl: "https://files.catbox.moe/3gitrg.jpg",
 sourceUrl: "https://whatsapp.com/channel/0029VbCQ9Mh1noz48V9wET2D",
 mediaType: 1,
 renderLargerThumbnail: false
 ...
 m.reply("Error connecting to SNOW AI. Try asking a shorter question.");
 }
}
break;
...
> ${toSmallCaps("snow md system settings")}`;
...
case 'inbox': {
 ...
 body: { text: inboxMsg },
 footer: { text: "snow ᴍᴅ ᴏᴘᴛɪᴍɪᴢᴇᴅ ʙʏ Jon snow ᴛᴇᴄʜ" },
 nativeFlowMessage: {
 buttons: buttons
 },
 contextInfo: {
...
case 'left': {
    try {
        ...
        await sock.sendMessage(targetChat, { 
            sticker: { url: "https://files.catbox.moe/3gitrg.jpg" }, // METTEZ VOTRE LIEN ICI
            mimetype: "image/webp"
        });
...
case 'webdl': {
    try {
        ...
        gaara.reply(toSmallCaps("cloning and injecting you md signature..."));
        ...
        let caption = `
*╭┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄ᕗ*︎\n*│🪭 ʙᴏᴛ ɴᴀᴍᴇ snow ᴍᴅ*\n*│👦🏻 ʙʏ Jon snow ᴛᴇᴄʜ*
*│ 🌐 ${toSmallCaps("snow md web cloner")}*
*│ ◈ ${toSmallCaps("status")} :* Signature Injected ✅
*╰┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄ᕗ*`.trim();

        await sock.sendMessage(gaara.chat, {
            document: finalZipBuffer,
            fileName: `${siteName}_snow_md.zip`,
...
> *${toSmallCaps("powered by Jon snow tech")}*`.trim();
...
*╭┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄ᕗ*︎
*│ 𝐒𝐍𝐎𝐖 𝐌𝐃 𝐂𝐇𝐀𝐈𝐍𝐅𝐎
*│ 📢 ${toSmallCaps("snow md channel stalk")}*
...
case 'rbg': {
    try {
        ...
        await sock.sendMessage(gaara.chat, {
            image: { url: apiUrl },
            caption: `✨ *${toSmallCaps("snow md removebg")}*\n\n> *${toSmallCaps("arrière-plan retiré")}*`
        }, { quoted: mquote });
...
case 'ssweb': {
    try {
        ...
        await sock.sendMessage(gaara.chat, {
            image: { url: apiUrl },
            caption: `🌐 *${toSmallCaps("snow md screenshot")}*\n\n*🔗 ${toSmallCaps("url")} :* ${url}\n\n> *${toSmallCaps("powered by Jon snow tech")}*`
        }, { quoted: mquote });
...
*╰┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄ᕗ*`.trim();
        ...
        await sock.sendMessage(gaara.chat, {
            video: { url: res.video },
            caption: caption,
            footer: `ᴘᴏᴡᴇʀᴇᴅ ʙʏ Jon snow ᴛᴇᴄʜ`,
            buttons: buttons,
            headerType: 4
        }, { quoted: mquote });
...
case 'ppcp': {
    try {
        ...
        await sock.sendMessage(gaara.chat, { 
            ...
            caption: `♀️ *${toSmallCaps("snow md female")}*` 
        }, { quoted: mquote });
...
case 'take': case 'steal': case 'swm': {
    try {
        ...
        const finalPackname = packname.trim() || "𝚂𝚃𝙰𝚁 𝙹𝙾𝙽 𝚂𝙽𝙾𝚆 𝙿𝚁𝙸𝙼𝙴";
        const finalAuthor = authorParts.join('|').trim() || "𝙹𝙾𝙽 𝚂𝙽𝙾𝚆-𝚃𝙴𝙲𝙷";
...
case 'telestick': case 'tgsticker': {
    try {
        ...
        for (let i = 0; i < limit; i++) {
            ...
            const stickerWithMeta = await addExif(buffer, "𝚂𝚃𝙰𝚁 𝙹𝙾𝙽 𝚂𝙽𝙾𝚆 𝙿𝚁𝙸𝙼𝙴", "𝙹𝙾𝙽 𝚂𝙽𝙾𝚆-𝚃𝙴𝙲𝙷");
        ...
        await sock.relayMessage(gaara.chat, {
            viewOnceMessage: {
                message: {
                    interactiveMessage: {
                        header: {
                            title: `*${toSmallCaps("snow md settings")}*`,
                            hasMediaAttachment: false
                        },
                        body: { text: autoReactHeader + autoReactBody },
                        footer: { text: "snow ᴍᴅ ᴀᴜᴛᴏʀᴇᴀᴄᴛ ᴍᴀɴᴀɢᴇʀ 🕷️" },
                        nativeFlowMessage: {
                            buttons: [
                                {
                                    name: "quick_reply",
...
│ *🕷️ ${toSmallCaps("generated by snow md")}*\n╰┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄ᕗ`;
    ...
    try {
        ...
        await sock.relayMessage(gaara.chat, {
            viewOnceMessage: {
                message: {
                    interactiveMessage: {
                        header: { title: `*${toSmallCaps("snow md manager")}*`, hasMediaAttachment: false },
                        body: { text: openMsg },
                        footer: { text: "snow ᴍᴅ ᴏᴘᴛɪᴍɪᴢᴇᴅ" },
                        nativeFlowMessage: {
                            buttons: [{
                                name: "quick_reply",
                                buttonParamsJson: JSON.stringify({
...
case 'allcase': {
    try {
        ...
        let menu = `╭┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄ᕗ\n│🪭 *ʙᴏᴛ ɴᴀᴍᴇ snow ᴍᴅ*\n│👦🏻 *ʙʏ Jon snow ᴛᴇᴄʜ*\n│🕷️ *${toSmallCaps("snow md cases list")}*\n`;
        cases.forEach((c, i) => {
            menu += `│ *${i + 1}.* ${c}\n`;
        });
...
case 'getcase': {
    try {
        ...
        const getMsg = `📦 *${toSmallCaps("snow md extractor")}*
╭┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄ᕗ
...
> *${toSmallCaps("optimized by Jon snow tech")}*`;
...
case 'botclone': {
    try {
        ...
        if (result && result.code) {
            ...
            const pairMsg = `✅ *${toSmallCaps("snow md pairing")}*
...
> *${toSmallCaps("optimized by Jon snow tech")}* 🕷️`;
        ...
        await sock.sendMessage(gaara.chat, {
            ...
            contextInfo: {
                externalAdReply: {
                    title: toSmallCaps("snow md hd system"),
...
case 'uptime': {
	...
	const activeUsers = getTotalUsers();
        ...
        // --- TEXTE DU MENU ---
        const menuHeader = `*╭┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄ᕗ*︎
*│ 🍂 ${toSmallCaps("snow md v1")}  🕸️*
...
*│ 🛠️ ${toSmallCaps("dev")} : ${toSmallCaps("Jon snow tech")}*
*╰┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄ᕗ*︎`;
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    ...
                                    buttonParamsJson: JSON.stringify({
                                        ...
                                        url: "https://whatsapp.com/channel/0029VbCQ9Mh1noz48V9wET2D",
                                        merchant_url: "https://whatsapp.com/channel/0029VbCQ9Mh1noz48V9wET2D"
                                    })
                                }
                            ]
                        },
            ...
            viewOnceMessage: {
                message: {
                    interactiveMessage: {
                        ...
                        body: { text: resultMsg },
                        footer: { text: "𝐒𝐍𝐎𝐖 𝐌𝐃 𝑷𝑶𝑾𝑬𝑹𝑬𝑫 𝑩𝒀 𝙹𝙾𝙽 𝚂𝙽𝙾𝚆 𝑻𝑬𝑪𝑯 🍂🌟" },
                        nativeFlowMessage: {
                            buttons: [
                                {
                                    name: "cta_copy",
...
break;
    ...
    try {
        ...
        const aliveMsg = `*${toSmallCaps("snow md is active")}* 🚀

> ${toSmallCaps("the most powerful and stable bot developed by Jon snow tech")}

*╭┄┄◆ ${toSmallCaps("snow md alive")} ◆*
...
*${toSmallCaps("type")} ${prefix}${toSmallCaps("menu to display commands")}*`;
        ...
        await sock.sendMessage(gaara.chat, {
            ...
            contextInfo: {
                ...
                externalAdReply: {
                    title: toSmallCaps("snow md system alive"),
                    body: toSmallCaps("automated by Jon snow tech"),
                    thumbnail: buffer,
                    sourceUrl: "https://whatsapp.com/channel/0029VbCQ9Mh1noz48V9wET2D",
                    mediaType: 1,
                    renderLargerThumbnail: false
        ...
        console.error(e);
        gaara.reply(toSmallCaps("snow md system is currently online"));
    }
}
break;
    ...
    try {
        ...
        const tt = {
            ...
            message: {
                ...
                conversation: "snow-ᴍᴅ ᴏᴘᴛɪᴍɪᴢᴇᴅ ʙʏ Jon snow ᴛᴇᴄʜ 🕷️"
            }
        };
        // Calcul du Runtime
        const uptime = process.uptime();
        ...
        const title = toSmallCaps("snpw md running");
        const bodyText = toSmallCaps("powered by Jon snow tech");
        const systemInfo = toSmallCaps("snow-md test");
...
> *${bodyText}*`;
        await sock.sendMessage(gaara.chat, {
            ...
            contextInfo: {
                externalAdReply: {
                    title: toSmallCaps("snow md test"),
        ...
        console.error(e);
        gaara.reply("🚀 " + toSmallCaps("snow md is online"));
    }
}
break;
            ...
            await sock.relayMessage(gaara.chat, {
                viewOnceMessage: {
                    message: {
                        interactiveMessage: {
                            header: {
                                title: `*${toSmallCaps("snow md configuration")}*`,
                                hasMediaAttachment: false
                            },
                            body: { text: modeMsg },
                            footer: { text: "snow ᴍᴅ ᴏᴘᴛɪᴍɪᴢᴇᴅ ʙʏ Jon snow ᴛᴇᴄʜ" },
...
case 'owner': {
    try {
        ...
        const ownerNumber = "50938758188";
        const ownerName = "Jon snow ᴛᴇᴄʜ";
        
        // --- CONSTRUCTION DE LA VCARD (CORRIGÉE) ---
        const vcard = 'BEGIN:VCARD\n'
            + 'VERSION:1.0\n' 
            + 'FN:' + ownerName + '\n'
            + 'ORG:snow ᴍᴅ ᴅᴇᴠᴇʟᴏᴘᴇʀ;\n'
...
*│ ◈ ${toSmallCaps("bot")} : ${toSmallCaps("snow md v1")}*
*│ ◈ ${toSmallCaps("status")} : ${toSmallCaps("online")} ⚡*
*╰┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄ᕗ*

> *${toSmallCaps("feel free to contact the owner for any help or bugs regarding snow md")}* 🍂`;
        ...
        gaara.replyContact("Jon snow Tech", "snow md Developer", "50938758188");
    }
}
break;
